...
\item В отличие от \biblatex, в \biblatexgost поля \bibfield{volume},
  ...
  Если поля \bibfield{volume},\textellipsis{} не начинаются с цифры, то они
  копируются в \bibfield{internalsortvolume},\textellipsis{} как есть.
  Если сортировка при этом некорректна, используйте поле \bibfield{sortvolume}.
