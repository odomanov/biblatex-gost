...
\svnRegisterRevision{75}{Версия 0.3.2}
\makeatletter
...
\begin{itemize}
\item Русский должен быть последним в списке языков при вызове \cmd{babel}, иначе возможны ошибки 
при выводе многотомных книг. 
\href{https://sourceforge.net/tracker/?func=detail&aid=3483207&group_id=244752&atid=1126005}{Причина выясняется.} 
