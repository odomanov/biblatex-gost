...
reorder). Поэтому, если вы хотите, чтобы в библиографии кириллические записи шли в начале, то в качестве обходного пути можете отредактировать файл .bbl, создаваемый \biber'ом
