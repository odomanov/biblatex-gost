...
определяется разработчиками
этого дистрибутива. Эта директория может отличаться (и отличается!) от директории
в вышеупомянутом архиве, поэтому при ручной установке настоятельно рекомендуется распаковывать
...
\biblatex~2.6\fnurl{http://sourceforge.net/projects/biblatex/files/biblatex-2.6/}
и \biber~1.6\fnurl{http://sourceforge.net/projects/biblatex-biber/files/biblatex-biber/1.6/}.
...
\begin{release}{0.?}{??-??-2013}
\item Переход на \biblatex~2.6 и \biber~1.6\see{sec:install}
