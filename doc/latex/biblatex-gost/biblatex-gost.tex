...
\newcommand*{\noitemspace}{\vspace{-\itemsep}\vspace{-\parsep}}
...
\biblatex~2.1\fnurl{http://sourceforge.net/projects/biblatex/files/biblatex-2.1/} 
и \biber~1.1\fnurl{http://sourceforge.net/projects/biblatex-biber/files/biblatex-biber/1.1/} 
или выше.
...
\item[gost-footnote-min]\noitemspace%
\item[gost-numeric-min]\noitemspace%
\item[gost-authoryear-min]\noitemspace%
...
Порядок вывода томов в многотомных изданиях. См.~\secref{sec:volparts}.
...
Порядок символов определяет порядок вывода частей.  По умолчанию \kvopt{volsorder}{vbpi}. 
...
\optitem[true]{citeurl,biburl}{\opt{true}, \opt{false}}\noitemspace%
\optitem[true]{citeisbn,bibisbn}{\opt{true}, \opt{false}}\noitemspace%
\optitem[true]{citedoi,bibdoi}{\opt{true}, \opt{false}}\noitemspace%
\optitem[true]{citeeprint,bibeprint}{\opt{true}, \opt{false}}%\noitemspace%
...
\bottomrule
\end{tabularx}
\caption{Значения по умолчанию опций \opt{citeurl}, \ldots, \opt{biburl}, \ldots}
\label{tab:bibcite}
\end{table}
...
\optitem{volsorder}[vpbi]{последовательность символов v, p, b, i}
\label{sorting}

Порядок вывода томов для многотомных изданий по умолчания. Подробнее см.~\secref{sec:volparts}.
...
\item Добавлено поле \bibfield{volsorder}\see{sec:newfields}
