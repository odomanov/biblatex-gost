...
\begin{release}{1.4}{??-??-2015}
\item В документации добавлено описание возможного способа обходу ошибки
сортировки источников на русском языке\see{sec:issues} 
\item Исправлен вывод \bibtype{article} для электронных публикаций.
\end{release}
