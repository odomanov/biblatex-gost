...
\item Обработка поля \bibfield{related} приведена в соответствие с \biblatex,
  в связи с чем вывод изменился.
  Кроме того, по умолчанию опция \opt{related} установлена в \opt{true}
...
\item Обработка поля \bibfield{related} приведена в соответствие с \biblatex,
  в связи с чем его вывод изменился.
