...
\begin{release}{0.6}{1-07-2012}% up to rev.257
\item Переход на \biblatex~2.1\see{sec:install}
...
\item Установлено по умолчанию \kvopt{inbookidid}{false}
\item Установлено по умолчанию \kvopt{firsinits}{true}
\item Изменён перевод некоторых строк
